...
public class BreadcrumbsView extends LinearLayout {
  ...
  private SeparatorView separatorView1;
  ...
  public void setFirst(boolean isVisite){
      if (separatorView1 != null){
        if (!isVisite) {
          separatorView1.setScaleX(0);
        } else {
          separatorView1.setScaleX(1);
        }
      }
  }
  ...
  private void createSteps() {
    ...
    int widthStep = (((getWidth() - widthDot) / nSeparators) - widthDot) / 2;

    steps = new ArrayList<>(nSeparators);
    separatorView1 =
            new SeparatorView(getContext(), true, visitedStepSeparatorColor,
